...
import { adminApi, type AdminBookmark } from '@/api/admin'
...
async function load() {
  ...
  error.value   = ''
  try {
    const res   = await adminApi.listBookmarks(page.value, limit)
...
<template>
  <div class="p-8">
    <h2 class="text-2xl font-bold text-gray-800 mb-6">Bookmarks</h2>
